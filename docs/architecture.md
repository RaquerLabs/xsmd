...
### Module Descriptions
*   **[main.go](file:///Users/gcgbarbosa/repos/gcgbarbosa/gcgb-md/cmd/gcgb-md-lsp/main.go)**: The entry point. Creates the server instance, registers handlers, and starts JSON-RPC standard input/output listeners.
*   **[internal/state/store.go](file:///Users/gcgbarbosa/repos/gcgbarbosa/gcgb-md/internal/state/store.go)**: The in-memory cache/store (`ServerState` and `DocumentInfo`). Houses cached Markdown files, link ranges, and titles.
*   **[internal/state/crawler.go](file:///Users/gcgbarbosa/repos/gcgbarbosa/gcgb-md/internal/state/crawler.go)**: Anchors project roots by finding `gcgb-md.toml` and climbs the directory tree finding files.
*   **[internal/parser/markdown.go](file:///Users/gcgbarbosa/repos/gcgbarbosa/gcgb-md/internal/parser/markdown.go)**: Converts raw Markdown text into an Abstract Syntax Tree (AST), extracting titles and character spans of notes.
*   **[internal/lsp/handlers.go](file:///Users/gcgbarbosa/repos/gcgbarbosa/gcgb-md/internal/lsp/handlers.go)**: The central router. Configures LSP server capabilities (folding, definition, backreferences, autocompletions).
*   **[internal/lsp/diagnostics.go](file:///Users/gcgbarbosa/repos/gcgbarbosa/gcgb-md/internal/lsp/diagnostics.go)**: Validates target paths against cache tables and the filesystem, generating highlights for broken links.
